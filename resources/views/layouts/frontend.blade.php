...
<html class="no-js" lang="">
  <head>
    ...
    <link rel="apple-touch-icon" href="{{ url('/frontend/images/content/logohunky.png') }}" />
    <!-- Place favicon.ico in the root directory -->

    <link rel="stylesheet" href="{{ url('/frontend/css/main.css') }}" />
    <link rel="icon" href="{{ url('/frontend/images/content/logohunky.png') }}" />
