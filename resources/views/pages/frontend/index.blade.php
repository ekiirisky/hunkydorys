...
@section('content')
    ...
    <section class="flex items-center hero">
      ...
      >
        <h1 class="text-3xl md:text-5xl leading-tight font-semibold">
          Your Satisfaction <br class="" />Is Our Priority
        </h1>
        <h2 class="px-8 text-base md:px-0 md:text-lg my-6 tracking-wide">
          Kami menyediakan sepatu original
          <br class="hidden lg:block" />dengan harga yang terjangkau
        <div>
          <a
      ...
      <div class="w-full inset-0 md:relative md:w-1/2">
        <div class="relative hero-image">
            ...
            <button
              ...
              <div class="absolute w-full h-full">
                <iframe
                  width="100%"
                  height="100%"
                  src="https://www.youtube.com/embed/mxCyqSIxnx8"
                  frameborder="0"
          ...
          <img
            src="/frontend/images/content/don3.png"
            alt="hero 1"
          ...
          @foreach($category as $categories)
            <div class="px-4 relative card group">
              ...
              >
                ...
                <img
                  src="{{ $categories->galleri()->exists() ? Storage::url($categories->galleri->first()->url) : 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mN88B8AAsUB4ZtvXtIAAAAASUVORK5CYII=' }}"
                  alt=""
    ...
    <section class="container mx-auto">
      <div class="flex justify-center flex-wrap">
        ...
        >
          <img src="./frontend/images/content/nike.jpg" width="150" alt="" class="mx-auto" />
        </div>
        <div
          class="w-full flex-auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0"
        >
          <img src="./frontend/images/content/adidaslogo.png" width="150" alt="" class="mx-auto" />
        </div>
        <div
          class="w-full flex-auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0"
        >
          <img
            src="./frontend/images/content/nb.png" width ="150" alt="" class="mx-auto"
          />
        </div>
        <div
          class="w-full flex-auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0"
        >
          <img src="./frontend/images/content/converse.png" alt="" width="150" class="mx-auto" />
        </div>
        <div
          class="w-full flex-auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0"
        >
          <img src="./frontend/images/content/vans.png" alt="" width="110" class="mx-auto" />
        </div>
      </div>
    </section>
    <!-- END: CLIENTS -->
